...
// Post para enviar informações pro mangoDB
...
//Rotas postagens
    ...
    router.get('/postagens/edit/:id', eAdmin, (req,res) => {
        Postagem.findOne({_id: req.params.id}).lean().then((postagem) => {
            ...
            Categoria.find().then((categorias) => {
                res.render('admin/editpostagens', {categorias: categorias.map(categorias => categorias.toJSON()), postagem: postagem})
    ...
    //essa não e uma forma tão segura
...
//Post postagens
    router.post('/postagens/nova', eAdmin,(req,res) => {
        ...
        if(req.body.categoria == '0'){
            erros.push({texto: 'Categoria invalida, registra uma categoria'})
        }
